...
const props = defineProps({profesor:{type:Object}});
const form = useForm({
...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Editar Profesor</h2>
        </template>

        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="p-4 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <form @submit.prevent="form.patch(route('profesors.update', profesor))"
                    class="mt-6 space-y-6 max-w-xl">
                        <InputLabel for="nombre" value="Profesor"></InputLabel>
